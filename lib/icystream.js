...
function _getStreamStation(url, callback) {
  return new Promise((resolve, reject) => {
    try {
      resolve(getStreamStation(url, callback));
    } catch (err) {
...
function getStreamStation(url, callback) {
  ...
  function errorCallback(error) {
    ...
    tearDown();
    console.log("errorCallback in icystream.js : line 107 ->" + error);
...
module.exports._getStreamStation = _getStreamStation;
